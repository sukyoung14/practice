...
let isLoggedIn = true;
if (isLoggedIn) console.log("환영합니다!");
...
const fruit = "apple";
if (fruit === "apple") console.log("사과입니다");
/* 출력 결과
사과입니다
*/
...
if (!isRaining) console.log("날씨가 맑습니다");
...
const examScore = 92;
if (examScore >= 90) console.log("우수합니다");
/* 출력 결과
우수합니다
*/
...
// 그렇지 않으면 "D등급"을 출력한다
const grade = 75;
if (grade >= 90) console.log("A등급");
else if (grade >= 80) console.log("B등급");
else if (grade >= 70) console.log("C등급");
else console.log("D등급");
/* 출력 결과
C등급
*/
...
const password = "1234";
if (username === "admin" && password === "1234") console.log("로그인 성공");
...
else console.log("이미 로그인되어 있습니다");
/* 출력 결과
로그인이 필요합니다
*/
...
if (userAge >= 20) {
  if (isStudent) console.log("성인 학생입니다");
  else console.log("성인입니다");
} else if (userAge < 20) console.log("미성년자입니다");
/* 출력 결과
성인 학생입니다
*/
...
const humidity = 60;
if (temperature >= 25 && humidity >= 70) console.log("더운 날씨입니다");
else if (temperature >= 25 && humidity < 70) console.log("따뜻한 날씨입니다");
else if (humidity < 70) console.log("시원한 날씨입니다");
/* 출력 결과
따뜻한 날씨입니다
*/
...
let finalPrice;
if (purchaseAmount >= 100000) finalPrice = purchaseAmount * 0.9;
else finalPrice = purchaseAmount;
...
if (userAge >= 21 && hasLicense && hasInsurance) console.log("완벽한 운전자");
else if (userAge >= 21 && hasLicense) console.log("운전 가능");
...
const isActive = true;
if (!isActive) console.log("비활성 계정");
else if (isActive) {
  if (userType === "premium" && userPoints >= 2000) console.log("VIP 등급");
...
userAge = 16;
const isDecaf = false;
if (drinkType === "coffee" && userAge >= 18) console.log("커피 주문 가능");
else if (drinkType === "coffee" && userAge < 18 && isDecaf)
  console.log("디카페인 커피 가능");
else if (drinkType === "tea") console.log("차 주문 가능");
else console.log("음료수만 가능");
/* 출력 결과
음료수만 가능
*/
